...
def translate(text, lang):
    ...
    "සිංහල": { #Sinhala
        ...
        "ಕನ್ನಡ": {  # Kannada translations
            ...
            "Adult Ticket Count is Completed": "ನೀವು ವಯಸ್ಕರ ಟಿಕೆಟ್ ಎಣಿಕೆಯನ್ನು ಪೂರ್ಣಗೊಳಿಸಿದ್ದೀರಿ",
            "You need": "ನೀವು ಬೇಕು",
            "number of Adult Tickets": "ವಯಸ್ಕರ ಟಿಕೆಟ್‌ಗಳ ಸಂಖ್ಯೆ",
            "Number of children tickets (₹5 each):": "ಮಕ್ಕಳ ಟಿಕೆಟ್‌ಗಳ ಸಂಖ್ಯೆ (ಪ್ರತಿ ₹5):",
            "Child Ticket Count is Completed": "ನೀವು ಮಕ್ಕಳ ಟಿಕೆಟ್ ಎಣಿಕೆಯನ್ನು ಪೂರ್ಣಗೊಳಿಸಿದ್ದೀರಿ",
            "number of Child Tickets": "ಮಕ್ಕಳ ಟಿಕೆಟ್‌ಗಳ ಸಂಖ್ಯೆೆ",
            ...
            "Thank you for visiting! Please reach out when you are ready to book.": "ಭೇಟಿ ನೀಡಿದ್ದಕ್ಕಾಗಿ ಧನ್ಯವಾದಗಳು! ನೀವು ಬುಕ್ ಮಾಡಲು ಸಿದ್ಧರಾದಾಗ ದಯವಿಟ್ಟು ಸಂಪರ್ಕಿಸಿ."
        },
        ...
        "മലയാളം": {  # Malayalam translations
            ...
            "Are you looking to book a museum ticket?": "നിങ്ങൾ ഒരു മ്യൂസിയം ടിക്കറ്റ് ബുക്ക് ചെയ്യാൻ നോക്കുകയാണോ?",
            "Yes": "അതെ",
            "No": "ഇല്ല",
            ...
            "Adult Ticket Count is Completed": "നിങ്ങൾ മുതിർന്നവർക്കുള്ള ടിക്കറ്റ് എണ്ണം പൂർത്തിയാക്കി",
            "You need": "നിങ്ങള്ക്ക് ആവശ്യമുണ്ട്",
            "number of Adult Tickets": "മുതിർന്നവർക്കുള്ള ടിക്കറ്റുകളുടെ എണ്ണം",
            "Number of children tickets (₹5 each):": "മക്കളുടെ ടിക്കറ്റുകളുടെ എണ്ണം (₹5 ഓരോ ടിക്കറ്റിനും):",
            "Child Ticket Count is Completed": "നിങ്ങൾ കുട്ടികളുടെ ടിക്കറ്റ് എണ്ണം പൂർത്തിയാക്കി",
            ...
            "Is parking required?": "നിങ്ങൾക്ക് പാർക്കിംഗ് സൗകര്യം ആവശ്യമുണ്ടോ?",
            ...
            "Are you willing to process the payment?": "പേയ്‌മെൻ്റ് പ്രോസസ്സ് ചെയ്യാൻ നിങ്ങൾ തയ്യാറാണോ?",
            "Proceeding to payment gateway...": "പെയ്മെന്റ് ഗേറ്റ്വേയിലേക്ക് നീങ്ങുന്നു...",
            "Booking not completed.": "ബുക്കിംഗ് പൂർത്തിയായിട്ടില്ല",
        ...
        "தமிழ்": {
            ...
            "Number of adult tickets (₹15 each):": "பெரியோர் டிக்கெட் எண்ணிக்கை (₹15 ஒவ்வொன்றும்):",
            "Adult Ticket Count is Completed": "பெரியோர் டிக்கெட் எண்ணிக்கை முடிந்தது",
            "You need": "உங்களுக்கு தேவை",
            "number of Adult Tickets": "பெரியோர் டிக்கெட் எண்ணிக்கை",
            "Number of children tickets (₹5 each):": "சிறுவர் டிக்கெட் எண்ணிக்கை (₹5 ஒவ்வொன்றும்):",
            "Child Ticket Count is Completed": "சிறுவர் டிக்கெட் எண்ணிக்கை முடிந்தது",
            "number of Child Tickets": "சிறுவர் டிக்கெட் எண்ணிக்கை",
        ...
        "తెలుగు": { #telugu
            ...
            "Child Ticket Count is Completed": "మీరు పిల్లల టిక్కెట్ల గణనను పూర్తి చేసారు",
            ...
            "Proceeding to payment gateway...": "చెల్లింపు గేట్‌వేకి కొనసాగుతోంది...",
